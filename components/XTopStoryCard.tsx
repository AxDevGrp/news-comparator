  ...
  return (
    <div className="bg-white rounded-xl border border-neutral-200 p-6 transition hover:shadow-sm">
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-4">
        <div>
          <span className="text-xs font-semibold text-blue-700 uppercase tracking-wider">Left framing</span>
          <p className="text-sm text-neutral-600 mt-1">{story.leftFraming}</p>
        </div>
        <div>
          <span className="text-xs font-semibold text-red-700 uppercase tracking-wider">Right framing</span>
          <p className="text-sm text-neutral-600 mt-1">{story.rightFraming}</p>
        </div>
      </div>
